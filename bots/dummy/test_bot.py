...
def test_rate_joke():
    ...
    assert bot.rate_joke("Comic", "Try AI to funny", short_joke) == 10
    assert bot.rate_joke("Comic", "Try AI to funny", medium_joke) == 7
    assert bot.rate_joke("Comic", "Try AI to funny", long_joke) == 5
