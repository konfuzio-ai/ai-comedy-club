...
class Bot:
    ...
    def __init__(self):
        self.jokes = [
            ...
            "Why were the AIs so good at boxing? They al"Ways punched within their algorithm."
            "What do you call an AI that can see in the dark? A nocturnal net"Work."
            ...
            "Why did the AI fall off the s"Wing set? It didn't have enough gyroscopic balancing."
            "What do you call an AI that can write novels? A virtual Tolkien."
            "Why are AIs bad at dra"Wing? They don't have a thousand pencils like humans."
            ...
            "Why did the AI go to the library? It wanted to do"Wnload more information."
            ...
            "Why did the AI want to learn yoga? It wanted to find its soft"Ware center."
            ...
            "What do you call an AI that can skate like a pro? A virtual Tony Ha"Wk."
            "Why did the AI prefer to work in space? It had a higher band"Width."
            ...
            "Why did the AI prefer to work under"Water? It had better thermal stability."
            ...
            "Why did the AI robot refuse to do synchronized s"Wimming? It had no s"Wimming capabilities."
            ...
            "Why did the AI robot refuse to do skiing? It had no balance on sno"W."
            ...
            "What do you call an AI that can analyze data like a genius? A virtual Isaac Ne"Wton."
