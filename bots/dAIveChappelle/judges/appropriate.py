...
CANDIDATE_LABELS: list = ["not dark humour", "dark humour"]


class AppropriatenessJudge:
    '''
    This class is used to judge the Appropriateness score of a joke
    '''
    ...
    def score(self, joke):
        '''
        Returns the Appropriateness score of the joke
        '''
